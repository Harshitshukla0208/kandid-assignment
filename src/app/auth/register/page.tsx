    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Register with email</h1>
          <p className="text-gray-600 mt-2">Register using your email address.</p>
        </div>

        <Card className="shadow-lg border-0">
          <CardContent className="p-6">
            {/* Google Sign Up */}
            <Button variant="outline" className="w-full mb-4 h-11 bg-transparent" onClick={handleGoogleSignup}>
